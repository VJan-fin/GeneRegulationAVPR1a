...
namespace GenskaRegulacijaAVPR1a
{
    public partial class mRNAForm : Form
    {
        ...
        private string startText = "Целта на оваа анимација е да го прикаже процесот на регулација на деградација на mRNA молекула добиена од генот AVPR1a. Тоа подразбира додавање на глукокортикоиди во цитоплазмата на клетката кои ја успоруваат деградацијата на mRNA молекулата.\r\n\r\nЗа да може да започне целиот процес, најпрво е потребно рибозомот да се поврзе со mRNA молекулата на местото наречено RBS, односно почетно место на транслација.\r\nЗа таа цел притисни ПОВРЗИ.";
        private string ribosomeMovingText = "Рибозомот е привлечена од RNA секвенцата која се наоѓа на почетното место на транслација, како резултат на голем број физички и хемиски привлечни сили. Тоа се нарекува афинитет.";
        private string translationText = "За да може да започне транслацијата потребно е да се избере ЗАПОЧНИ ТРАНСЛАЦИЈА. Со тоа преостанатото време на “живот“ на mRNA молекулата ќе почне да се намалува. За да го продолжиме времето и да се осигураме дека транслацијата ќе се изврши, можеме со клик на “+“ да додаваме од соодветниот глукокортикоид и со тоа да се зголемува времето на тајмерот.\r\nИзбери РЕСЕТИРАЈ доколку добиеш порака дека mRNA молекулата деградирала и не може да продолжи транслацијата. Обиди се повторно со додавање на повеќе глукокортикоиди.";
        private string translationGoingText = "Процесот на транслација на mRNA молекулата е во тек./r/n За да го продолжиме времето и да се осигураме дека транслацијата ќе се изврши, можеме со клик на “+“ да додаваме од соодветниот глукокортикоид и со тоа да се зголемува времето на тајмерот.";
        ...
        public mRNAForm()
        {
            ...
            lblAldosterone.ExplanationText = "Aldosterone е тип на глукокортикоиден лек.";
            lblRibosome.ExplanationText = "Рибозомите се органели во кои се остварува процесот на транслација, односно синтезата на протеините, со учество на mRNA и tRNA. Секој рибозом се состои од две морфолошки субединици, кои се разликуваат по големина и тежина, наречени голема и мала субединица. Тоа се универзални органели за сите живи клетки. Се создаваат во јадренцето и по нивното создавање преминуваат во цитоплазмата.";
