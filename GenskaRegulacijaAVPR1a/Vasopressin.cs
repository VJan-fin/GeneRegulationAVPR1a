    ...
    public class Vasopressin : Molecule
    {
        ...
        public override void move()
        {
            ...
            if (this.IsAttached)
            {
                ...
                if ((this.CurrentPosition.X + dx >= this.vasopressinEndSite.X - 40))
                {
            ...
            else
            {
                ...
                if (/*(this.CurrentPosition.X + dx >= this.vasopressinBindingSite.X) && */(this.CurrentPosition.Y + dy >= this.vasopressinBindingSite.Y))
                {
